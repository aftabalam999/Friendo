...
const VideoCard = ({ video, currentUser }) => {
  ...
  return (
    <div ref={ref} className="snap-start snap-always relative w-full h-[calc(100vh-160px)] bg-black flex-shrink-0">
      {/* Video Element */}
      <video
        ref={videoRef}
        src={video.videoUrl}
      ...
      <motion.div
        ...
        className="absolute bottom-16 left-0 right-20 p-4 text-white bg-gradient-to-t from-black/60 to-transparent"
      >
        {/* User Info */}
